			...
			<div class="right-panel" style="">
				...
				<ol>
					<li id="book-style">
						...
						<div class="styles">
						<input name="documentsize" id="document-size-standard" type="radio" value="standard" onclick="changeSize(this);"<?php if($Size=='standard'){?> checked="checked"<?php }?> /> 8.5" x 11"<br />
						<input name="documentsize" id="document-size-travel" type="radio" value="travel" onclick="changeSize(this);"<?php if($Size=='travel'){?> checked="checked"<?php }?> /> 5.5" x 11"<br />
						</div>
					...
					<li id="book-size">
						...
						<h2 style="width: 30px;"></h2>
						<div class="section-header">PAPER</div>
						
						<div class="styles">
							<div style="padding:3px 0px 3px 0px"><strong>White Paper</strong></div>
							<input name="documentsize" id="document-size-standard" type="radio" value="standard" onclick="changeSize(this);"<?php if($Size=='standard'){?> checked="checked"<?php }?> /> 24 lb Bright<br />
							<input name="documentsize" id="document-size-standard" type="radio" value="standard" onclick="changeSize(this);"<?php if($Size=='standard'){?> checked="checked"<?php }?> /> 28 lb Premium<br />
							<input name="documentsize" id="document-size-standard" type="radio" value="standard" onclick="changeSize(this);"<?php if($Size=='standard'){?> checked="checked"<?php }?> /> 100 lb glossy<br />
							<div style="padding:3px 0px 3px 0px"><strong>Card Stock</strong></div>
							<input name="documentsize" id="document-size-standard" type="radio" value="standard" onclick="changeSize(this);"<?php if($Size=='standard'){?> checked="checked"<?php }?> /> 100 lb Regular<br />
							<input name="documentsize" id="document-size-standard" type="radio" value="standard" onclick="changeSize(this);"<?php if($Size=='standard'){?> checked="checked"<?php }?> /> 100 lb Glossy<br />				
						</div>
					...
					<li id="print-pages-in2">
						...
						<div class="styles">
						<input name="documentcolor" id="document-color-blackwhite" type="radio" value="blackwhite" onclick="changeColor(this);"<?php if($Color=='blackwhite'){?> checked="checked"<?php }?> /> None<br />
						<input name="documentcolor" id="document-color-color" type="radio" value="color" onclick="changeColor(this);"<?php if($Color=='color'){?> checked="checked"<?php }?>  /> Lamination<br />
						<input name="documentcolor" id="document-color-color" type="radio" value="color" onclick="changeColor(this);"<?php if($Color=='color'){?> checked="checked"<?php }?>  /> Glossy Coating<br />
						</div>
